"""
Django settings for sorteo_valentin project.
...
SECRET_KEY = 'django-insecure-3#pcqg2km1z@@q&q!ocjodrf3+wt+wx!9ip#f)=arqo_p-g6sq'
...
WSGI_APPLICATION = 'sorteo_valentin.wsgi.application'
